...
# case it's using [`ngResource`](http://docs.angularjs.org/api/ngResource) and
# [`ngRoute`](http://docs.angularjs.org/api/ngRoute)) and finally getting the Angular module as an app ready, loading
# [`controller/app-controller.coffee`](app-controller.html) and bootstrapping the document, and away we go.
define [
